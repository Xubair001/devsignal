...
export function FeedPage() {
  ...
  return (
    <>
      ...
      <Card className="mb-3.5 flex gap-2.5 border-transparent bg-warn-wash p-3.5">
      ...
      {d && (
        <div className="mb-3.5 flex flex-wrap items-center gap-2 text-[12px] text-ink-3">
              ...
              <table className="w-full min-w-[640px] border-collapse">
                ...
                <thead>
                  <tr className="border-b border-line bg-raised">
                    <th className="px-3.5 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wider text-ink-3">Role</th>
                    <th className="px-3.5 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wider text-ink-3">Failed check</th>
                    <th className="px-3.5 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wider text-ink-3">Why</th>
                  </tr>
                </thead>
                <tbody>
                  {excluded.data.items.map((x) => (
                    <tr key={x.opportunity_id} className="border-b border-line transition-colors last:border-0 hover:bg-hover">
                      <td className="px-3.5 py-2.5 text-[13px] font-medium">{x.title}</td>
                      ...
                      <td className="px-3.5 py-2.5 text-[12.5px] text-ink-3">{x.reasons.join(' ')}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
